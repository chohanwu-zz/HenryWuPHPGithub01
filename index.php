...
<head>
    ...
    <title>Henry's Practice Page 123</title>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top"><?php echo 'PHP on Azure'; ?></a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        <span class="name">Henry's PHP Practice</span>
                        <hr class="star-light">
                        <span class="skills">Microsoft Azure</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2">
                    <p>This is a testing page for PHP on Azure.</p>
                </div>
                <div class="col-lg-4">
                    <p>This is a testing page for PHP on Azure.</p>
                </div>
